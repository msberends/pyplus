"""Aanbiedingen page — full-width promotions view."""
...
async def create_promos_page() -> None:
    ...
    with ui.element("div").classes("sp-cockpit-root"):
        create_nav_rail(active="promos", session=session)
        ...
        with ui.element("div").classes("sp-page-content sp-page-lane"):
            try:
                ...
                log.error("Promos lane crashed: %s", exc)

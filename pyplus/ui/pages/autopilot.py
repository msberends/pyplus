"""Autopilot page — plan review, substitute resolution, one-click cart fill."""
...
async def create_autopilot_page() -> None:
    ...
    if session is None:
        app.storage.browser["_login_next"] = "/autopilot"
    ...
    with ui.element("div").classes("sp-cockpit-root"):
        create_nav_rail(active="autopilot", session=session)
